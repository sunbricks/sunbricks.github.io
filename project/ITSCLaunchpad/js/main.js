let SwiperTop = new Swiper('.ITSC_swiper-container', {
    spaceBetween: 20,
    centeredSlides: true,
    speed: 5000,
    autoplay: {
...
const Day = document.querySelector("#ITSC_Day");
const Hour = document.querySelector("#ITSC_Hour");
const Min = document.querySelector("#ITSC_Min");
const Sec = document.querySelector("#ITSC_Sec");
...
const DayPC = document.querySelector("#ITSC_Day_PC");
const HourPC = document.querySelector("#ITSC_Hour_PC");
const MinPC = document.querySelector("#ITSC_Min_PC");
const SecPC = document.querySelector("#ITSC_Sec_PC");
